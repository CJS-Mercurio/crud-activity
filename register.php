...
<?php 
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($input_username)) {
      ...
      $username_err = "Username can only contain letter, numbers, and underscore.";
    ...
    if (empty(trim($_POST['confirm_password']))) {
      ...
      $confirm_password_err = "Please input password confirmation.";
    ...
    // If the variable errors are empty insert the data to users table in username and password
